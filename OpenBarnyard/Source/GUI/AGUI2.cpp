...
TBOOL AGUI2::OnCreate()
{
	...
	pDebugCanvas->AddChildHead(&m_oFPS);
	...
	pDebugCanvas->AddChildHead(&m_oPlayerInfo);
	...
	pDebugCanvas->AddChildHead(&m_oTexturesInfo);
	...
	pDebugCanvas->AddChildHead(&m_oMemStats);
