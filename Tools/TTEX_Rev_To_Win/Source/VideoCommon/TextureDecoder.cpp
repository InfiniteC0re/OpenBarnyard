...
#include "TextureDecoder_Util.h"
#include "VideoCommon/sfont.inc"
//#include "TextureDecoder_Common.cpp"
...
int TexDecoder_GetTexelSizeInNibbles(TextureFormat format)
{
    ...
    case TextureFormat::XFB:
        return 4;
    default:
        TOSHI_ERROR("Invalid Texture Format {}! (GetTexelSizeInNibbles)", format);
        return 1;
    }
}
...
int TexDecoder_GetBlockWidthInTexels(TextureFormat format)
{
    ...
    case TextureFormat::XFB:
        return 16;
    default:
        TOSHI_ERROR("Invalid Texture Format {}! (GetBlockWidthInTexels)", format);
        return 8;
    }
}
...
int TexDecoder_GetBlockHeightInTexels(TextureFormat format)
{
    ...
    case TextureFormat::XFB:
        return 1;
    default:
        TOSHI_ERROR("Invalid Texture Format {}! (GetBlockHeightInTexels)", format);
        return 4;
    }
}
...
int TexDecoder_GetEFBCopyBlockWidthInTexels(EFBCopyFormat format)
{
    ...
    case EFBCopyFormat::XFB:
        return 16;
    default:
        TOSHI_ERROR("Invalid EFB Copy Format {}! (GetEFBCopyBlockWidthInTexels)", format);
        return 8;
    }
}
...
int TexDecoder_GetEFBCopyBlockHeightInTexels(EFBCopyFormat format)
{
    ...
    case EFBCopyFormat::XFB:
        return 1;
    default:
        TOSHI_ERROR("Invalid EFB Copy Format {}! (GetEFBCopyBlockHeightInTexels)", format);
        return 4;
    }
}
...
TextureFormat TexDecoder_GetEFBCopyBaseFormat(EFBCopyFormat format)
{
    ...
    default:
        TOSHI_ERROR("Invalid EFB Copy Format {}! (GetEFBCopyBaseFormat)", format);
