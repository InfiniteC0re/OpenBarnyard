...
bool Toshi::TThread::SetPriority(HANDLE a_hThreadHnd, PRIORITY a_ePriority)
{
	TASSERT(a_hThreadHnd != NULL, "");
...
void Toshi::TThread::Exit(TThread* a_pThread)
{
...
Toshi::TThreadManager::TThreadManager()
{
...
void Toshi::TThreadManager::RemoveThread(TThread* a_pThread)
{
