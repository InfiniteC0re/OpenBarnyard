...
namespace Toshi
{
	...
	public:
		...
		t_CreateTObject m_pTObjectCTOR; //0x4
		t_CreateTObjectAtPlace m_pTObjectCTORAtPlace; //0x8
		...
		TClass(const char* name, TClass* parent, t_CreateTObject create, t_CreateTObjectAtPlace createAtPlace, t_RegisterScriptingAPI scripting, void* unk, size_t size);
