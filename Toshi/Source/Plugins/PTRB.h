...
public:
	...
	public:
		...
		public:
			...
			Ptr(PTRBSections::MemoryStream* stack, TUINT offset) : m_Stack(stack), m_Offset(offset) { }
			Ptr(PTRBSections::MemoryStream* stack, T* ptr) : m_Stack(stack), m_Offset(stack->GetOffset(ptr)) { }
...
public:
	...
	PTRBWriter(const std::string& filepath) : m_HDRX(VERSION) { ReadFromFile(filepath); }
