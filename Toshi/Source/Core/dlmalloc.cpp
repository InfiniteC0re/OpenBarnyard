...
#ifndef CORRUPTION_ERROR_ACTION
#define CORRUPTION_ERROR_ACTION(m) TCRITICAL("!\"TMemory: Memory system corruption detected!\"")
#endif /* CORRUPTION_ERROR_ACTION */

#ifndef USAGE_ERROR_ACTION
#define USAGE_ERROR_ACTION(m,p) TBREAK(); TCRITICAL("!\"TMemory: Memory block footer corruption detected - the block being free'd was probably overrun!\"")
#endif /* USAGE_ERROR_ACTION */
...
/* Init bins for a new mstate that is otherwise zeroed out */
