...
void T2GUITransform::Rotate( TFLOAT a_fAngle )
{
	TFLOAT fSin, fCos;
...
void T2GUITransform::PreMultiply( const T2GUITransform& a_rTransform )
{
	TVector2 vecRot0 = m_aMatrixRows[ 0 ];
	TVector2 vecRot1 = m_aMatrixRows[ 1 ];
...
void T2GUITransform::Scale( TFLOAT a_fScaleX, TFLOAT a_fScaleY )
{
...
void T2GUITransform::Transform( TVector2& a_rOutVec, const TVector2& a_rTransformVec ) const
{
...
void T2GUITransform::GetInverse( T2GUITransform& a_rInverse ) const
{
...
void T2GUITransform::SetScale( TFLOAT a_fScaleX, TFLOAT a_fScaleY )
{
...
void T2GUITransform::SetFromScale( TFLOAT a_fScaleX, TFLOAT a_fScaleY )
{
	SetIdentity();
	Scale( a_fScaleX, a_fScaleY );
}
...
void T2GUITransform::Multiply( T2GUITransform& a_rOutTransform, const T2GUITransform& a_rA, const T2GUITransform& a_rB )
{
