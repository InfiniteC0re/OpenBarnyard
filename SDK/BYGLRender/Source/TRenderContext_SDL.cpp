...
{
	m_Projection.m_f11 = ( m_oProjParams.m_Proj.x * 2.0f ) / m_oViewportParams.fWidth;
	m_Projection.m_f12 = 0.0f;
	m_Projection.m_f13 = 0.0f;
	m_Projection.m_f14 = 0.0f;
	m_Projection.m_f21 = 0.0f;
	m_Projection.m_f22 = -( ( m_oProjParams.m_Proj.y * 2.0f ) / m_oViewportParams.fHeight );
	m_Projection.m_f23 = 0.0f;
	m_Projection.m_f24 = 0.0f;
	m_Projection.m_f31 = ( m_oProjParams.m_Centre.x * 2.0f ) / m_oViewportParams.fWidth - 1.0f;
	m_Projection.m_f32 = -( ( m_oProjParams.m_Centre.y * 2.0f ) / m_oViewportParams.fHeight - 1.0f );
	m_Projection.m_f33 = m_oProjParams.m_fFarClip / ( m_oProjParams.m_fFarClip - m_oProjParams.m_fNearClip );
	m_Projection.m_f34 = 1.0f;
	m_Projection.m_f41 = 0.0f;
	m_Projection.m_f42 = 0.0f;
	m_Projection.m_f43 = -( ( m_oProjParams.m_fNearClip * m_oProjParams.m_fFarClip ) / ( m_oProjParams.m_fFarClip - m_oProjParams.m_fNearClip ) );
