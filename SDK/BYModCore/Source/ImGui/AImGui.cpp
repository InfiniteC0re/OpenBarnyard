...
void AImGUI::UnlockInput()
{
	m_iNumInputLocks--;

	if ( m_iNumInputLocks <= 0 )
	{
...
TBOOL AImGUI::OnInputEvent( Toshi::TInputInterface::InputEvent* a_pInputEvent )
{
	if ( m_iNumInputLocks == 0 ) return TFALSE;
